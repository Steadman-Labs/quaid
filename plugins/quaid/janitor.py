...
Examples of CONFIRM:
  - "Wendy doesn't like spicy food" vs "Wendy and spicy food don't mix" → same fact
...
def _lock_file_path() -> Path:
    return _workspace() / "data" / ".janitor.lock"
...
if __name__ == "__main__":
    ...
    stats_file = _workspace() / "logs" / "janitor-stats.json"
    usage = get_token_usage()
    stats_data = {
