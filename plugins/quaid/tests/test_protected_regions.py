...
class TestWorkspaceAuditProtectedRegions:
    ...
    def test_review_strips_protected_from_opus_input(self, tmp_path):
        ...
        with patch("workspace_audit.WORKSPACE_DIR", tmp_path):
    ...
    def test_apply_skips_protected_sections(self, tmp_path):
        ...
        with patch("workspace_audit.get_config", return_value=cfg), \
             ...
             patch("workspace_audit.BACKUP_DIR", tmp_path / "backups"):
...
def snippets_workspace_dir(tmp_path):
    ...
    soul_snippets.BACKUP_DIR = tmp_path / "backups" / "soul-snippets"
