...
class SessionTimeoutManager {
    ...
    async recoverStaleBuffers() {
        ...
        for (const filePath of this.listBufferFiles()) {
            ...
            try {
                ...
                await this.extract(extractionMessages, sid, "Timeout");
    ...
    listSignalFiles() {
        try {
            if (!fs.existsSync(this.pendingSignalDir))
                return [];
