...
from memory_graph import Node, MemoryGraph, get_graph, OLLAMA_URL

CLUSTERING_MODEL = "qwen2.5:7b"  # Same model for consistency
...
def call_ollama_clustering(prompt: str, max_tokens: int = 50) -> str:
    """Call Ollama for clustering classification."""
    try:
        ...
        print(f"[clustering] Ollama error: {e}")
        return ""
