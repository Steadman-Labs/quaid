...
Usage:
    ...
    QUAID_OWNER=default python3 mcp_server.py  # set owner identity
...
Environment variables:
    ...
    QUAID_ADAPTER       Force adapter: "standalone" or "openclaw"
...
def session_recall(action: str = "list", session_id: str = "", limit: int = 5) -> dict:
    ...
    if action == "load" and session_id:
        ...
        if session_path.exists():
            ...
            transcript = parse_session_jsonl(str(session_path))
