...
def update_doc_from_diffs(
    ...
    is_tools_doc = Path(doc_path).name == "TOOLS.md"
    tools_path_rule = (
        "PATH STYLE (MANDATORY FOR TOOLS.md):\n"
        "- All file references must be workspace-relative and start with `~/`.\n"
        "- Do NOT use bare filenames like `PROJECT.md` or `README.md`.\n"
        "- Examples: `~/projects/portfolio-site/PROJECT.md`, "
        "`~/projects/recipe-app/docs/api.md`.\n"
    ) if is_tools_doc else ""
    if core_info:
