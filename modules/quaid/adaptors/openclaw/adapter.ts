      ...
      if (isSystemEnabled("projects")) {
        ...
        if (_QUAID_INSTANCE) {
          ...
          prependSystemContext = [
            ...
            ``,
            `[PROJECT CREATION — MANDATORY, AUTO-EXECUTE WITHOUT ASKING]`,
            `Before you write a single file, spawn a coding agent, or start any multi-step task:`,
            `  STEP 1: Run: quaid registry create-project <name> --source-roots <path>`,
            `  STEP 2: Then do the work inside that project.`,
            ``,
            `CRITICAL RULES — NO EXCEPTIONS:`,
            `- DO NOT ask the user for project name or path. Infer them from context and run create-project immediately.`,
            `- DO NOT ask clarifying questions about where to put the project. Just pick a reasonable path and proceed.`,
            `- DO NOT use /tmp, /var, or other system directories as source-roots. Use ~/quaid/shared/projects/<name>/ instead.`,
            `  Example: quaid registry create-project my-tool --source-roots ~/quaid/shared/projects/my-tool/`,
