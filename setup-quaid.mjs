...
//   - OpenClaw: Auto-detected via CLAWDBOT_WORKSPACE env or clawdbot/openclaw on PATH
//
...
// Python env setup — sets the right env var depending on mode
const PY_ENV_SETUP = IS_OPENCLAW
...
function showBanner() {
  ...
  const lines = [
    ...
    "",
    " ".repeat(16) + C.dim("· ") + C.cyan("░▒▓") + C.bold(" LONG-TERM MEMORY SYSTEM ") + C.cyan("▓▒░") + C.dim(" ·"),
    "",
  ];
