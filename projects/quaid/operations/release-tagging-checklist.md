# Release Tagging Checklist (v0.2.2-alpha)
...
- Review release notes: `docs/releases/v0.2.2-alpha.md`.

## 3) Version + tag
- Create annotated tag:
  - `git tag -a v0.2.2-alpha -m "Quaid v0.2.2-alpha"`
- Push branch + tag:
  - `git push origin main`
  - `git push origin v0.2.2-alpha`

## 4) GitHub release
- Create release from tag `v0.2.2-alpha`.
- Paste notes from `docs/releases/v0.2.2-alpha.md`.
